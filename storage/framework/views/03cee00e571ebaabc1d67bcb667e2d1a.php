...
<?php endif; ?>
        ...
        <div class="bg-white shadow p-6 mr-4 mt-8">
            ...
            <div class="space-y-4">
                ...
                <!-- Button Tampilkan -->
                <a href="<?php echo e(route('dekan.verifikasiruang')); ?>" class="w-full bg-gray-200 text-black block font-semibold py-2 rounded-md hover:bg-gray-300 text-center">
                    Tampilkan
                </a>
            </div>
        </div>
...
</html><?php /**PATH C:\SIgma\resources\views/content/dekan/ruang.blade.php ENDPATH**/ ?>