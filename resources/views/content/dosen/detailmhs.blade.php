    ...
    <main class="p-16 md:ml-64 h-auto pt-20">
        ...
        <div class="relative rounded-lg bg-white h-48 mb-4 p-4">
            ...
            <form class="absolute left-8 top-8 w-[320px]">
                <select id="countries" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
