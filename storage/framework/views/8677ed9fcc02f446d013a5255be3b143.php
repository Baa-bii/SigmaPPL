            ...
            <table id="data-tabel-jadwal" class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border-collapse">
                ...
                <?php $__currentLoopData = $jadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white text-black dark:bg-gray-800 status-row" 
                        ...
                        <!-- Nama Mata Kuliah -->
                        <td class="p-4 whitespace-nowrap"><?php echo e($item->matakuliah->nama_mk ?? 'N/A'); ?></td>

                        <!-- Waktu -->
                        <td class="p-4 whitespace-nowrap"><?php echo e($item->waktu->jam_mulai ?? 'N/A'); ?> - <?php echo e($item->waktu->jam_selesai ?? 'N/A'); ?></td>

                        <!-- Dosen -->
                        <td class="p-4 whitespace-nowrap"><?php echo e($item->dosenmatkul->dosen->nama_dosen ?? 'N/A'); ?></td>

                        <!-- Semester -->
                        <td class="p-4 whitespace-nowrap text-center"><?php echo e($item->matakuliah->semester ?? 'N/A'); ?></td>
                        ...
                        <!-- Gedung -->
                        <td class="p-4 whitespace-nowrap text-center"><?php echo e($item->ruang->gedung ?? 'Tidak Ada Gedung'); ?></td>

                        <!-- Tahun Akademik -->
                        <td class="p-4 whitespace-nowrap text-center"><?php echo e($item->id_TA); ?></td>

                        <!-- Form Setujui/Tolak -->
                        <td class="p-4 flex gap-2 items-center flex-wrap md:flex-nowrap">
                            <!-- Tombol Setujui -->
                            <form action="<?php echo e(route('dekan.verifikasi.update', $item->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\SIgma\resources\views/content/dekan/verifikasijadwal.blade.php ENDPATH**/ ?>