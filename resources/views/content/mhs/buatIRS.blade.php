...
@if(isset($status) && $status === 'Aktif' && $statusIRSMHS === 'Belum Disetujui' || !isset($statusIRSMHS))
...
@elseif(isset($statusIRSMHS) && $statusIRSMHS === 'Sudah Disetujui')
...
@elseif(isset($statusIRSMHS) && $statusIRSMHS === 'Pembatalan')
