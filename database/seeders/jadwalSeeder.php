...
Log::info('Inserting data jadwal hari senin');
Jadwal::create([
    'hari' => 'Senin',
    'kelas' => 'B',
...
Log::info('Data jadwal hari senin inserted successfully');

// ...

// Insert data jadwal hari selasa
Log::info('Inserting data jadwal hari selasa');
Jadwal::create([
    'hari' => 'Selasa',
    'kelas' => 'C',
    'id_waktu' => $id_waktu_07,
...
Log::info('Data jadwal hari selasa inserted successfully');

// ...

// Insert data jadwal hari rabu
Log::info('Inserting data jadwal hari rabu');
Jadwal::create([
    'hari' => 'Rabu',
    'kelas' => 'D',
    'id_waktu' => $id_waktu_07,
...
Log::info('Data jadwal hari rabu inserted successfully');

// ...

// Insert data jadwal hari Kamis
Log::info('Inserting data jadwal hari Kamis');
Jadwal::create([
    'hari' => 'Kamis',
    'kelas' => 'D',
    'id_waktu' => $id_waktu_07,
...
Log::info('Data jadwal hari Kamis inserted successfully');

// ...

// Insert data jadwal hari jumat
Log::info('Inserting data jadwal hari jumat');
Jadwal::create([
    'hari' => 'Jumat',
    'kelas' => 'D',
...
Log::info('Data jadwal hari jumat inserted successfully');
``` 'kode_prodi' => 'INF123', 
    'created_at' => now(),
    'updated_at' => now(),
]);
...
Jadwal::create([
    'hari' => 'Senin',
    'kelas' => 'BAmbil id_TA dari semester_aktif yang relevan
