...
<?php endif; ?>
    ...
    <main class="p-16 md:ml-64 h-auto pt-20">
        <form action="<?php echo e(route('akademik.ruang.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="m-6">
...
</html><?php /**PATH C:\00 KULIAH\00 SEMESTER 5\SiGMA\SigmaPPL\resources\views/content/akademik/createruang.blade.php ENDPATH**/ ?>