    ...
    <div class="bg-white p-6 w-full lg:w-1/3 border border-gray-300">
        ...
        <div class="border border-gray-300 p-4 mb-6">
            <div class="mb-4">
                ...
                <h3 class="font-semibold mb-2 text-xs">Semester: <span class="font-normal"><?php echo e($mhs->semester_aktif->where('is_active', true)->first()->semester ?? 'Tidak Diketahui'); ?></span></h3>
            </div>
            <!-- Garis pemisah -->
            <hr class="border-t-2 border-gray-300 mb-4">
            <!-- Bagian Informasi Akademik -->
            <div class>
                <p class="text-gray-600 mb-1 text-xs">Th. Ajaran: <span class="font-normal"><?php echo e($mhs->semester_aktif->where('is_active', true)->first()->tahun_akademik ?? 'Tidak Diketahui'); ?></span></p>
                    ...
                    <?php $__currentLoopData = $mataKuliah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input type="checkbox" id="checkbox-<?php echo e($mk->kode_mk); ?>" 
                                    value="<?php echo e($mk->kode_mk); ?>" 
                                    class="course-checkbox" 
                                    <?php echo e($mataKuliahDitampilkan->contains('kode_mk', $mk->kode_mk) ? 'checked' : ''); ?> />
                                <label for="checkbox-<?php echo e($mk->kode_mk); ?>" class="w-full py-2 ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">
        ...
        <div class="mt-6">
            ...
            <div id="displayedCourses" class="space-y-3">
                <?php if($mataKuliahDitampilkan->isEmpty()): ?>
                    <p class="text-xs text-gray-500">Tidak ada mata kuliah untuk semester ini.</p>
                <?php else: ?>
                    <?php $__currentLoopData = $mataKuliahDitampilkan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matkul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div id="selected-<?php echo e($matkul->kode_mk); ?>"class="p-4 bg-gray-50 rounded-lg shadow mb-3">
                            <div class="flex items-center gap-2">
                                <i class="fas fa-check text-green-500"></i>
                                <div>
                                    <!-- <h4 class="font-semibold text-sm"><?php echo e($matkul->nama_mk); ?></h4>
                                    <p class="text-xs"><?php echo e(strtoupper($matkul->jenis_mk)); ?> (<?php echo e($mk->kode_mk); ?>)</p>
                                    <p class="text-xs">Semester <?php echo e($matkul->semester); ?></p>
                                    <p class="text-xs"><?php echo e($matkul->sks); ?> SKS</p> -->
                                    <h4 class="font-semibold text-sm"><?php echo e($matkul->nama_mk); ?> - <?php echo e($matkul->sks); ?>  SKS (Semester <?php echo e($matkul->semester); ?>) - <?php echo e(strtoupper($matkul->jenis_mk)); ?> - (<?php echo e($matkul->kode_mk); ?>)</h4>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($currentJadwal->isNotEmpty()): ?>
                                <?php $__currentLoopData = $currentJadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-40 h-auto p-2 bg-white border-l-4 border-blue-500 rounded-lg shadow-lg mb-2">
                                        <h5 class="mb-2 text-xs font-bold text-gray-900"><?php echo e($item->nama_mk); ?></h5>
                                        <p class="text-xs text-red-500 font-semibold"> <?php echo e(strtoupper($item->jenis_mk)); ?> (<?php echo e($item->kode_mk); ?>)</p>
                                        <p class="text-xs text-gray-700">(SMT <?php echo e($item->semester); ?>) (<?php echo e($item->sks); ?> SKS)</p>
                                        <p class="text-xs text-gray-700">Kelas: <?php echo e($item->kelas); ?></p>
                                        <div class="flex items-center mt-2 text-xs text-gray-600"><?php echo e($item->jam_mulai); ?></div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
...
<?php /**PATH /var/www/sigmappl/resources/views/content/mhs/buatIrs.blade.php ENDPATH**/ ?>