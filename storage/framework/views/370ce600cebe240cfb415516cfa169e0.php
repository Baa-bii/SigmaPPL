            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div class="flex items-center justify-between flex-wrap md:flex-row pb-8 bg-white dark:bg-gray-900">
                    ...
                    <div class="relative ml-8 mt-8">
                        ...
                        <div id="dropdownAction" class="z-10 hidden border border-gray-300 bg-white divide-y divide-gray-100 rounded-lg shadow w-50 dark:bg-gray-700 dark:divide-gray-600">
                            ...
                            <li><a href="#" data-filter="sudah_disetujui" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'sudah_disetujui' ? 'bg-gray-300' : ''); ?>">Semua Sudah Disetujui</a></li>
                                <li><a href="#" data-filter="belum_disetujui" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'belum_disetujui' ? 'bg-gray-300' : ''); ?>">Semua Belum Disetujui</a></li>
                                <li><a href="#" data-filter="sudah_isi_irs" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'sudah_isi_irs' ? 'bg-gray-300' : ''); ?>">Semua Sudah Isi IRS</a></li>
                                <li><a href="#" data-filter="belum_isi_irs" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'belum_isi_irs' ? 'bg-gray-300' : ''); ?>">Semua Belum Isi IRS</a></li>
                                <li><a href="#" data-filter="sudah_registrasi" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'sudah_registrasi' ? 'bg-gray-300' : ''); ?>">Semua Aktif</a></li>
                                <li><a href="#" data-filter="sudah_registrasi" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'sudah_registrasi' ? 'bg-gray-300' : ''); ?>">Semua Cuti</a></li>
                                <li><a href="#" data-filter="belum_registrasi" class="block px-4 py-2 hover:bg-gray-300 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white <?php echo e(request('filter') == 'belum_registrasi' ? 'bg-gray-300' : ''); ?>">Semua Belum Registrasi</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $mahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4"><?php echo e($mhs->nim); ?></td>
                                <td class="px-6 py-4"><?php echo e($mhs->programStudi->nama_prodi ?? 'Tidak Ditemukan'); ?></td>
                                <td class="px-6 py-4"><?php echo e($mhs->angkatan); ?></td>
                                <td class="px-6 py-4"><?php echo e($mhs->jalur_masuk); ?></td>
                                <td class="px-6 py-4"><?php echo e(number_format($mhs->ip_lalu, 2)); ?></td>
                                <td class="px-6 py-4"><?php echo e($mhs->sks_diambil ?? '-'); ?></td>
                                <td class="px-6 py-4"><?php echo e($mhs->status ?? 'Belum Registrasi'); ?></td>
                            </tr>
                ...
                <nav class="flex items-center justify-between pt-4" aria-label="Table navigation">
                    ...
                    <ul class="inline-flex items-center -space-x-px text-sm h-8 mr-5 mb-5">
                        ...
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e($mahasiswa->previousPageUrl()); ?>&per_page=<?php echo e($perPage); ?>&angkatan=<?php echo e($angkatan); ?>" class="flex items-center justify-center px-3 h-8 text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    Previous
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php for($i = 1; $i <= $mahasiswa->lastPage(); $i++): ?>
                            ...
                            <?php else: ?>
                                <li>
                                    <a href="<?php echo e($mahasiswa->url($i)); ?>&per_page=<?php echo e($perPage); ?>&angkatan=<?php echo e($angkatan); ?>" class="flex items-center justify-center px-3 h-8 text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                        <?php echo e($i); ?>
                        ...
                        <?php if($mahasiswa->hasMorePages()): ?>
                            <li>
                                <a href="<?php echo e($mahasiswa->nextPageUrl()); ?>&per_page=<?php echo e($perPage); ?>&angkatan=<?php echo e($angkatan); ?>" class="flex items-center justify-center px-3 h-8 text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    Next
                                </a>
                            </li>
                        <?php else: ?>
...
</html><?php /**PATH /var/www/sigmappl/resources/views/content/dosen/perwalian.blade.php ENDPATH**/ ?>