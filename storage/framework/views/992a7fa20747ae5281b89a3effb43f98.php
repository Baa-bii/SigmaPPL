                                ...
                                <td class="w-4 p-4">
                                    <div class="flex items-center pl-2">
                                        <?php if($mhs->irs->isNotEmpty()): ?>
                                            ...
                                            <label for="checkbox-table-search-<?php echo e($mhs->nim); ?>" class="sr-only">checkbox</label>
                                        <?php endif; ?>
                                    </div>
                                </td>
...
</html><?php /**PATH C:\00 KULIAH\00 SEMESTER 5\SiGMA\SigmaPPL\resources\views/content/dosen/perwalian.blade.php ENDPATH**/ ?>