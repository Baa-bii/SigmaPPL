...
<?php endif; ?>
    <!-- Container Utama -->
<!-- BUAT IRS -->
<div class="md:ml-64 h-auto relative flex-grow" id="buat-irs">
<?php if(isset($semester_aktif) && $semester_aktif->is_active == 1): ?>
    <!-- Sidebar Informasi Mahasiswa -->
    <div class="bg-white pt-12 p-6 w-full lg:w-1/3 border border-gray-300">
        ...
        <div class="border border-gray-300 p-4 mb-6">
            <div class="mb-4">
                ...
                <h3 class="font-semibold mb-2 text-xs">Semester: <span class="font-normal"><?php echo e($semester_aktif->semester ?? 'Tidak Diketahui'); ?></span></h3>
            </div>
            <!-- Garis pemisah -->
            <hr class="border-t-2 border-gray-300 mb-4">
            <!-- Bagian Informasi Akademik -->
            <div class>
                <p class="text-gray-600 mb-1 text-xs">Th. Ajaran: <span class="font-normal"><?php echo e($semester_aktif->tahun_akademik ?? 'Tidak Diketahui'); ?></span></p>
            ...
            <td class="border border-gray-300 p-2 text-center">
                ...
                <?php if($currentJadwal->isNotEmpty()): ?>
                    <?php $__currentLoopData = $currentJadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mb-2">
                            <h5 class="text-xs font-bold text-gray-900"><?php echo e($item->nama_mk); ?></h5>
                            <p class="text-xs text-red-500 font-semibold">
                                <?php echo e(strtoupper($item->jenis_mk)); ?> (<?php echo e($item->kode_mk); ?>)
                            </p>
                            <p class="text-xs text-gray-700">
                                (SMT <?php echo e($item->semester); ?>) (<?php echo e($item->sks); ?> SKS)
                            </p>
                            <p class="text-xs text-gray-700">Kelas: <?php echo e($item->kelas); ?></p>
                            <p class="text-xs text-gray-600">
                                <?php echo e($item->jam_mulai); ?>
...
<?php /**PATH C:\Users\user\Downloads\sigmaPPL\resources\views/content/mhs/buatIRS.blade.php ENDPATH**/ ?>