                                                        ...
                                                        <div class="relative bg-white p-6 w-full max-w-lg rounded-lg shadow">
                                                            ...
                                                            <form id="edit_modal" method="POST" action="{{ route('kaprodi.jadwal.update', $item->id_jadwal) }}">
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <select name="kode_mk" id="kode_mk" class="form-select bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 w-full p-2.5" required>
                                                                        @foreach ($matakuliah as $mk)
                                                                            <option value="{{ $mk->kode_mk }}" {{ $mk->kode_mk == $item->kode_mk ? 'selected' : '' }}>
                                                                                {{ $mk->nama_mk }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div id="jadwal-kelas-container" class="mb-4">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <input type="text" id="kelas" name="kelas" class="form-input bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5" value="{{ $item->kelas }}" required>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            <label for="id_jadwal" class="block text-sm font-medium">ID Jadwal</label>
                                                                            <input type="text" id="id_jadwal" name="id_jadwal" class="form-input bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5" value="{{ $item->id_jadwal }}" required>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <select id="id_ruang" name="id_ruang" class="form-select bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5" required>
                                                                                @foreach ($ruang as $ru)
                                                                                    <option value="{{ $ru->id }}" {{ $item->id_ruang == $ru->id ? 'selected' : '' }}>{{ $ru->gedung }}{{ $ru->nama }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <select id="id_waktu" name="id_waktu" class="form-select bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5" required>
                                                                                @foreach ($waktu as $wt)
                                                                                    <option value="{{ $wt->id }}" {{ $item->id_waktu == $wt->id ? 'selected' : '' }}>{{ $wt->jam_mulai }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <script>
                                                    document.addEventListener('DOMContentLoaded', function () {
                                                        ...
                                                        modals.forEach((modal) => {
                                                            ...
                                                            const kelasData = @json($item->kelas || []); // Ambil data kelas
