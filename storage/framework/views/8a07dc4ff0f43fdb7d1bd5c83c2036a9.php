        ...
        <div class="flex flex-col items-center justify-center px-6 py-6 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="<?php echo e(route('auth.verify')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div>
                        ...
                        <button type="submit" class="w-full text-white bg-yellow-500 hover:bg-black ease-out duration-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Log in</button> 
                    </form>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\user\Downloads\sigmaPPL\resources\views/auth/login.blade.php ENDPATH**/ ?>