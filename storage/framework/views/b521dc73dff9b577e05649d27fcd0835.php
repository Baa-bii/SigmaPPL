                                                ...
                                                <td class="px-4 py-2 border">
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        <button type="button" 
                                                            ...
                                                            data-sks="<?php echo e($item->sks); ?>"
                                                            data-semester="<?php echo e($item->semester); ?>"
                                                            data-jenis="<?php echo e($item->jenis_mk); ?>"
                                                            data-dosen="<?php echo e($item->dosen->pluck('nama_dosen')->join(', ')); ?>">
...
</html><?php /**PATH C:\PPL\SiGMA\resources\views/content/kaprodi/matakuliah.blade.php ENDPATH**/ ?>